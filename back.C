...
void test(int i)
{
  ...
  using namespace Unites_mag ;
      ...
      #pragma omp critical
      {
      out1 <<star.r_circ()*10 <<setw(15) << star.ray_eq ()*10<< setw(15);
      out1<< star.ray_pole ()*10 << setw(15) << star.mass_g ()/msol << setw(15);
      out1<< star.mass_b ()/msol << setw(15) << star.MagMom()/1.e32 << setw(15) ;
      out1<< star.Magn()(0)(0,0,0,0)*mag_unit/1.e13 <<setw(15);
      out1<<star.Magn()(0).va.val_point(star.l_surf()(0,0),star.xi_surf()(0,0),0.,0.)*mag_unit/1.e13;
      out1<<setw(15)<<star.Magn()(1).va.val_point(star.l_surf()(0,0),star.xi_surf()(0,0),M_PI/2.,0.)*mag_unit/1.e13 <<endl ;
      }
